...
public class HeadGrepSedTest {
	...
	public void chainSuccess() throws AbstractApplicationException,
		...
		shell.parseAndEvaluate(
				"head -n 1 sample.txt | grep \"9000\" | sed s/over/lower/", bao);
	...
	public void chainFailHeadWrongFile() throws AbstractApplicationException,
			ShellException {
		ByteArrayOutputStream bao = new ByteArrayOutputStream();
		shell.parseAndEvaluate(
	...
	@Test
	public void chainFailGrepNothing() throws AbstractApplicationException,
			ShellException {
		ByteArrayOutputStream bao = new ByteArrayOutputStream();
		shell.parseAndEvaluate(
				"head -n 1 sample.txt | grep \"nonsense\" | sed s/over/lower/",
				bao);
