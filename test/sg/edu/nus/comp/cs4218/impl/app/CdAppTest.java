...
public class CdAppTest {
	...
	public void setUp() throws Exception {
		...
		tempTestDirectory = new File(currentDirectory + File.separator + tempFolder);
	...
	public void tearDown() throws Exception {
		...
		// Delete the temporary folder and change the  current Directory to previous case
	...
	public void testCdAppWithNullOutputStreamArgument() {
		...
		try {
			...
			assertEquals(e.getMessage(),"cd: " + Consts.Messages.OUT_STR_NOT_NULL);
		}
	}
	...
	public void testCdAppWithMultipleArgs() {
		...
		try {
			...
			assertEquals("cd: " + Consts.Messages.EXPECT_ONE_ARG,e.getMessage());
		}
	}
	...
	public void testCdAppForFolders() {
		...
		try {
			...
			assertEquals(currentDirectory + File.separator + tempFolder, directoryAfterCd );
